...
public class signUp {
    ...
    public void writeFile(String fileName, ArrayList<customer> list) throws IOException {
        ...
        for (int i = 0; i < list.size(); i++) {
            String row = "";
            row += Integer.toString(list.get(i).getID()) + "\t";
...
//Doc file//
    ...
    public void signUpUser(ArrayList<customer> list) throws IOException, InterruptedException {
        ...
        System.out.println("***********THONG TIN NGUOI DUNG DANG KY**********");
        //Nhap userName//
        do {
            Scanner sc = new Scanner(System.in);
...
//        } else {
        ...
        System.out.println("*****----------HOAN THANH HO SO NGUOI DUNG--------*****");
        System.out.println("*****----------CAM ƠN DA SU DUNG DICH VU CUA CHUNG TOI--------*****");
